...
The first step for you will be to load your mass loss by temperature data. This package was developed using TGA data produced by a Netzsch TGA-FTIR thermogravimetric analyser, which outputs a table with temperature and mass loss for each point of measurement. If your TGA machine outputs data in another format, you'll need to reformat like the example below, or [get in touch with us](http://www.github.com/smwindecker/mixchar/issues), and we'll add new functionality. 
