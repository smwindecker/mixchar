...
fs_model <- function (dataframe, params, lb, ub) {
  ...
  if (length(params) == 12) {
    ...
    start_list <- list(height_1 = params[1], skew_1 = params[2], position_1 = params[3], width_1 = params[4],
                       height_2 = params[5], skew_2 = params[6], position_2 = params[7], width_2 = params[8],
                       height_3 = params[9], skew_3 = params[10], position_3 = params[11], width_3 = params[12])
  ...
  if (length(params) == 16) {
    ...
    start_list <- list(height_0 = params[1], skew_0 = params[2], position_0 = params[3], width_0 = params[4],
                       height_1 = params[5], skew_1 = params[6], position_1 = params[7], width_1 = params[8],
                       height_2 = params[9], skew_2 = params[10], position_2 = params[11], width_2 = params[12],
                       height_3 = params[13], skew_3 = params[14], position_3 = params[15], width_3 = params[16])
