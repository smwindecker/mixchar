...
fs_mixture_wrap_4 <- function (x, h1, h2, h3, h4, s1, s2, s3, s4, p1, p2, p3, p4, w1, w2, w3, w4) {

  params <- c(h1, h2, h3, h4, s1, s2, s3, s4, p1, p2, p3, p4, w1, w2, w3, w4)
  fs_mixture_4(x, params)
