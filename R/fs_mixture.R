...
#' @param h0 height value for curve 0, if present
#' @param s0 shape value for curve 0, if present
#' @param p0 position value for curve 0, if present
#' @param w0 width value for curve 0, if present
