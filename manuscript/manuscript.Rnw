...
3. Research Fellow, Centre for Integrative Ecology, School of Life and Environmental Sciences, Deakin University, Burwood Campus, Burwood VIC 3124, Australia \\
4. Assistant Professor, Biological Sciences, University of Southampton, Highfield Campus, Southampton SO17 1BJ, UK \\
5. Associate Professor, Centre for Integrative Ecology, School of Life and Environmental Sciences, Deakin University, Burwood Campus, Burwood VIC 3124, Australia \\
6. Research Fellow, School of BioSciences, University of Melbourne, Parkville VIC 3010, Australia
...
Once we have calculated the rate of mass loss, we use the \verb|deconvolve| function to estimate the proportions of carbon components. Under the hood, it does so with a series of steps: it crops the derivative rate of mass loss data, estimates parameter values from the non-linear model, and finally integrates under each resulting curve to estimate weight proportions of primary components. We explain these steps in detail below. \\
\\
...
R packages: \verb|minpack.lm|, \verb|nloptr|, \verb|tmvtnorm|, \verb|zoo|.
